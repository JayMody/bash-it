...
alias chr-syn='open -n "/Applications/Google Chrome.app" --args --profile-directory="Profile 10"'
...
# @mcmaster profile 3
alias chr-mac='open -n "/Applications/Google Chrome.app" --args --profile-directory="Profile 3"'
...
# jaymody10 profile 2
alias chr-jay='open -n "/Applications/Google Chrome.app" --args --profile-directory="Profile 2"'

# jaykmody profile 9
alias chr-jkm='open -n "/Applications/Google Chrome.app" --args --profile-directory="Profile 9"'
...
alias chr-mag='open -n "/Applications/Google Chrome.app" --args --profile-directory="Profile 11"'
